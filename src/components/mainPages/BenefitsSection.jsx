  ...
  return (
    <div className="font-inria text-xl flex justify-center items-center flex-col md:p-10 p-2">
      ...
      <div className="flex flex-wrap justify-center items-center gap-5">
        <div className="flex flex-col justify-center items-center m-5 border border-purple-default rounded-lg shadow-xl md:w-96 md:h-80 sm:w-80 sm:h-96">
          <img
            src={Cardapio}
            alt="Imagem de um prato com garfo e faca representando que teremos cardápios diferentes."
            className="w-28 h-28 rounded-full mt-5"
          />
          <p className="mt-5 text-purple-default text-2xl">Receba cardápios exclusivos e dicas práticas!</p>
          <p className="text-black text-xl mt-5 px-4 mb-5 sm:mb-0">Refeições planejadas, fáceis e práticas, para simplificar a sua rotina.</p>
        </div>
        ...
        <div className="flex flex-col justify-center items-center m-5 border border-purple-default rounded-lg shadow-xl md:w-96 md:h-80 sm:w-80 sm:h-96">
          <img
            ...
            className="w-28 h-28 rounded-full mt-5"
          />
          <p className="mt-5 text-purple-default text-2xl">Contato direto com a Nutri Gerusa durante todo o programa!</p>
          <p className="text-black text-xl mt-5 px-4 mb-5 sm:mb-0">Acompanhamento dedicado para te ajudar a alcançar seus objetivos.</p>
        </div>
        ...
        <div className="flex flex-col justify-center items-center m-5 border border-purple-default rounded-lg shadow-xl md:w-96 md:h-80 sm:w-80 sm:h-96">
          <img
            ...
            className="w-28 h-28 rounded-full mt-5"
          />
          <p className="mt-5 text-purple-default text-2xl">Dicas de treino!</p>
          <p className="text-black text-xl mt-5 px-4 mb-5 sm:mb-0">Exercícios que complementam sua transformação física e mental.</p>
        </div>
        ...
        <div className="flex flex-col justify-center items-center m-5 border border-purple-default rounded-lg shadow-xl md:w-96 md:h-80 sm:w-80 sm:h-96">
          <img
            ...
            className="w-28 h-28 rounded-full mt-5"
          />
          <p className="mt-5 text-purple-default text-2xl">Organização e planejamento para uma rotina equilibrada!</p>
          <p className="text-black text-xl mt-5 px-4 mb-5 sm:mb-0">Alinhe sua alimentação, treinos e dia a dia para resultados consistentes.</p>
        </div>
        ...
        <div className="flex flex-col justify-center items-center m-5 border border-purple-default rounded-lg shadow-xl md:w-96 md:h-80 sm:w-80 sm:h-96">
          <img
            ...
            className="w-28 h-28 rounded-full mt-5"
          />
          <p className="mt-5 text-purple-default text-2xl">Faça parte do grupo exclusivo no WhatsApp!</p>
          <p className="text-black text-xl mt-5 px-4 mb-5 sm:mb-0">Receba suporte diário e compartilhe sua jornada com outras pessoas.</p>
        </div>
        ...
        <div className="flex flex-col justify-center items-center m-5 border border-purple-default rounded-lg shadow-xl md:w-96 md:h-80 sm:w-80 sm:h-96 ">
          <img
            ...
            className="w-28 h-28 rounded-full mt-5"
          />
          <p className="mt-5 text-purple-default text-2xl">Resultados rápidos e sustentáveis!</p>
          <p className="text-black text-xl mt-5 px-4 mb-5 sm:mb-0">Perca peso de forma saudável e mantenha o progresso após o programa.</p>
        </div>
      </div>
    </div>
  );
