        ...
        <div className="mx-auto">
            <div className="flex flex-row justify-center gap-4 mt-5">            
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div className="flex lg:flex-row flex-col items-center justify-center gap-4 mt-3">
                        <div className="md:flex md:flex-row md:items-center md:justify-center gap-5">
                            <div className="flex flex-col border border-purple-default rounded-lg shadow-xl md:w-60 md:h-96 w-80 p-5 gap-5">
                    ...
                    <div className="flex lg:flex-row flex-col items-center justify-center gap-4 mt-5">
                        <div className="md:flex md:flex-row md:items-center md:justify-center gap-5">
                            <div className="flex flex-col border border-purple-default rounded-lg shadow-xl md:w-60 md:h-96 w-80 py-5 gap-5">
                            ...
                            <div className="flex flex-col border border-purple-default rounded-lg shadow-xl md:w-60 md:h-96 w-80 py-5 px-2 gap-5">
                        ...
                        <div className="flex flex-col border border-purple-default rounded-lg shadow-xl md:w-60 md:h-96 w-80 py-5 px-1 gap-5">
