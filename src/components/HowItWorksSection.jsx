            ...
            <div className="flex flex-row justify-center gap-4 mt-5">            
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div className="flex md:flex-row flex-col items-center justify-center gap-4 mt-3">
                        <div className="flex flex-col border border-purple-default rounded-lg shadow-xl md:w-60 w-80 p-5 gap-5">
                    ...
                    <div className="flex md:flex-row flex-col items-center justify-center gap-4 mt-5">
                        <div className="flex flex-col border border-purple-default rounded-lg shadow-xl md:w-60 w-80 py-5 gap-5">
                        ...
                        <div className="flex flex-col border border-purple-default rounded-lg shadow-xl md:w-60 w-80 py-5 px-2 gap-5">
                        ...
                        <div className="flex flex-col border border-purple-default rounded-lg shadow-xl md:w-60 w-80 py-5 px-1 gap-5">
