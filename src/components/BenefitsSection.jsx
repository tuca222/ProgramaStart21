...
const BenefitsSection = () => {
    return (
      <div className="font-inria text-xl flex justify-center items-center flex-col">
        <div className=" text-purple-default mb-7 mt-7 ml-9 mr-9 mx-auto border-x-4 border-green-default transform skew-x-6 border-y-4 skew-y-6 rounded-lg bg-green-default md:w-96">
